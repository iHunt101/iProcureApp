<div class="modal fade" id="annual_record" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
				<form role="form" method="GET" action="a_page.php">
					<div class="form-group">
						<label>Agency</label>
						<input type="hidden" name="page" value="view_annual_record">
