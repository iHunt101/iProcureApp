						...
						<div class="col-lg-12" >
							...
							<div class="panel-body panel_menu gppb_menu">
									<ul class="nav nav-pills nav-stacked sidebar_nav gp_hov">
										<li><a style="cursor:pointer" onclick="proc(111)" data-toggle="" onclick=""> PROC 111 </a></li>
										<li><a style="cursor:pointer" onclick="proc(112)">PROC 112</a></li>
										<li><a style="cursor:pointer" onclick="proc(113)"> PROC 113 </a></li>
										<li><a style="cursor:pointer"  onclick="proc(114)"> PROC 114</a></li>
										<li><a href='english_menu.php?page=english_menu_home' style="cursor:pointer" ><i class="fa fa-arrow-left"></i> Back </a></li>
