...
<div class="panel panel-danger">
    <div class="panel-heading">  Business Opportunities Survey</div>
...
<div class="panel panel-danger">
    <div class="panel-heading"> Business Opportunities</div>
    <div class="panel-body">
...
$sql2 = urlencode('SELECT '.$bid_info.'.ref_id,awardee,closing_date,tender_title,org_id,contract_amt,business_category FROM ' . $bid_info . '
...
$date = $dt->format('M-d-Y');
   ...
   echo "<tr>";
    ...
    echo "<td><strong> " . $value2['ref_id'] ." : ". $value2['tender_title']."</strong> 
    <table style='font-size:11px;' border='0'> 
    <tr><td>
    Paying Entity: </td><td>".$value2['org_id']."
    </td></tr>
    <tr><td>
    Awardee: </td><td>".$value2['awardee']."
    </td></tr>
    <tr><td>
    <a style='color:red'>Closing Date :</td><td>". $date."</a>
    </td></tr>
	<tr>
		<td>Contract Amount:</td><td> ".'&nbsp&nbsp&nbspP'.number_format($value2['contract_amt'],2)."</td>
	</tr>
    </table>
     </td>";
