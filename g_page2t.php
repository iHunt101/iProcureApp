						...
						<div class="col-lg-12" >
							...
							<div class="panel-body panel_menu gppb_menu">
									<ul class="nav nav-pills nav-stacked sidebar_nav gp_hov">
										<li><a style="cursor:pointer" onclick="proc('111t')"> PROC 111 </a></li>
										<li><a style="cursor:pointer" onclick="proc('112t')">PROC 112</a></li>
										<li><a style="cursor:pointer" onclick="proc('113t')"> Proc 113 </a></li>
										<li><a style="cursor:pointer"  onclick="proc('114t')"> Proc 114</a></li>
										<li><a href='tagalog_menu.php?page=tagalog_menu_home' style="cursor:pointer" ><i class="fa fa-arrow-left"></i> Back </a></li>
