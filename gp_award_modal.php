<div class="modal fade" id="gp_award" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title" id="myModalLabel">Contract Awarded</h4>
      </div>
      <div class="modal-body">
				<form role="form" method="GET" action="gp_page.php">
					<div class="form-group">
						<input type="hidden" name="page" value="gp_award">
