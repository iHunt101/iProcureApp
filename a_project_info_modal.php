<div class="modal fade" id="project_info" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
				<form role="form" method="GET" action="a_page.php">
					<div class="form-group">
						<label>Agency</label>
						<input type="hidden" name="page" value="project_info">
